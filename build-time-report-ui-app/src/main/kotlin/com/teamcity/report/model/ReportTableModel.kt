 ...
 *         Date:  25.10.2017
 */
data class ReportTableNode(val name: String, var duration: Long = 0, val childrens: MutableList<ReportTableNode> = mutableListOf(), var parentId: String = ROOT_PARENT_PROJECT_ID) {
